...
<div class="formDiv">
	<form:form action="manager/note/edit.do" modelAttribute="note">
		...
		<table>
			<tbody>
				<tr>
					<td><form:label path="trip.title">
							<spring:message code="note.trip" />:
							</form:label></td>
					<td><form:input path="trip.title" /> <form:errors
							cssClass="error" path="trip.title" /></td>
				</tr>
				<tr>
					<td>
					<spring:message code="moment.pattern" var="momentPattern" />
					<fmt:formatDate var="fmtDate" value="${moment}" pattern="${momentPattern}"/>
					...
					<td>
						<spring:message code="moment.pattern" var="momentPattern" />
						<fmt:formatDate var="fmtDate" value="${moment}" pattern="${momentPattern}"/>					
						<form:input path="moment" readonly="true" value="${fmtDate}" />
						<form:errors cssClass="error" path="moment" /></td>
